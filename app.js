...
function toggleRender() {
  if (characterRender) {
    ...
    characters.map((armut) => {
      characterRow.innerHTML += `<div class="justify-content-center col-xl-4 col-lg-4 col-sm-6 mt-5" id="filterDiv" data-id="${armut.homeworld}">
            <div class=" card fw-bold text-light border-light" style="width: 18rem;">
              <img src="${armut.pic}" class="card-img-top object-fit-contain" alt="..." style="height: 350px;">
              <div class="card-body">
